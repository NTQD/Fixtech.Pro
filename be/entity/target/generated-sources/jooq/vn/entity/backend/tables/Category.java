...
public class Category extends TableImpl<CategoryRecord> {
    ...
    /**
     * The reference instance of <code>ecom.category</code>
     */
    ...
    /**
     * The column <code>ecom.category.id</code>.
     */
    ...
    /**
     * The column <code>ecom.category.name</code>.
     */
    public final TableField<CategoryRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(200), this, "");

    /**
     * The column <code>ecom.category.description</code>.
     */
    ...
    /**
     * Create an aliased <code>ecom.category</code> table reference
     */
    ...
    /**
     * Create a <code>ecom.category</code> table reference
     */
    public Category() {
    ...
    public List<UniqueKey<CategoryRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_CATEGORY_NAME);
    }

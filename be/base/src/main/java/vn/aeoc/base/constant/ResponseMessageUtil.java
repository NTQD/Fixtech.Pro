...
public class ResponseMessageUtil {
    ...
    public static final String DUPLICATED_USER = "Số điện thoại tạo tài khoản đã tồn tại trong hệ thống";
    public static final String DUPLICATED_EMAIL = "email tạo tài khoản đã tồn tại";
